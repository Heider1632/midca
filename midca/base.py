...
from midca.goaltime import Goaltime
...
class BaseModule:
    ...
    def init(self, mem, goaltime, world = None):
        self.mem = mem
...
class MIDCA:
            ...
            for module in modules:
                ...
                try:
                    ...
                    module.init(world = self.world,
                                mem = self.mem, goaltime = self.goaltime)
    ...
    # this funcion determines the nex_phase and saved the information  current phase 
    def next_phase(self, verbose = 2, meta = False):
        # here this variables contain the current phase information
...
class PhaseManager:
    ...
    def __init__(self, world = None, verbose = 2, display = None, storeHistory = False, metaEnabled = False):
        ...
        self.goaltime = self.midca.goaltime
            ...
            if usingInterface:
                ...
                if val == "q":
                    ...
                    try:
                        ...
                        # entonces no podemos usar el log no lose te voy a llamar por hangouts listo espere no lo van a despedir si me llama? jajaja
                    ...
                    if txt:
                        self.logger.log(txt)
                        # debes cambiar el valor de un parametro en el archivo logging.py paraque te genere 
                        # cual valor?

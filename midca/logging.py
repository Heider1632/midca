...
class Logger:
    ...
    def __init__(self, keys = [], filesStayOpen = True, verbose=2):
        '''
    ...
    def logEvent(self, event):
        # this function recive the data and save in files .log.
        # y no habra alguna forma de identificar los eventos de seleccion del
        # goal actual y goal alcanzado?
        # debe haber por que el log lo dice solo que no se a donde exactamente hace eso 
